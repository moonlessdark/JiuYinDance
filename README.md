...
### 关于世界竞拍价格设置  
<div align=center>
<img src="https://github.com/moonlessdark/JiuYinDance/blob/master/Resources/Readme/世界竞拍.png">
</div>  

* 1、只支持扫描当前页面的最多7个竞拍物品，不支持向下滚动翻页。物品倒计时结束后会自动消失，所以只需要关注第一页的7个物品即可。建议每次只扫描前2个产品，加快扫描速度。    
* 2、出价顺序为从下往下依次出价竞拍。如果某个物品的当前竞价人显示为自己的角色，那么这个物品就不会继续出价了   
* 3、物品的当前出价在“最小竞拍价格”和“最大竞拍价格-10L”之间时，才会出价。 如果此物品的价格+10L后，已经大于表格中设置的最大价格时，那么就不会继续出价了  
* 4、如果不想竞拍某个物品，那么就不需要设置此物品的“最大竞拍价格”。  
* 5、“最小竞拍价格”不填写时，会默认使用“最大竞拍价格 - 20” 作为最小竞拍价格。意味着正常情况下，此价格会出价2次。  
* 6、“最小”和“最大”价格的单位是“两”，如果是你要设置价格有“锭”这个单位时，请自动换算为“两”。例如：2锭299两，请输入 2299 即可。  
* 7、给众多物品设置了竞拍价格区间后，可以点击“保存”价格，将价格信息保存在本地。下次打开程序可以之间使用。  
* 8、点击“重置价格”，只会清空表格中的所有价格区间设置，不会清理已经保存在本地的信息。  
* 9、如果缺少了某个物品，请联系作者增加一下。  
* 10、此逻辑未经过严谨测试，使用此脚本时请勿在包裹中保留太多银子，避免造成损失。   
