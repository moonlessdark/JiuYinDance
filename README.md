...
* 6、给众多物品设置了竞拍价格区间后，可以点击“保存”价格，将价格信息保存在本地。下次打开程序可以之间使用。  
* 7、点击“重置价格”，只会清空表格中的所有价格区间设置，不会清理已经保存在本地的信息。  
* 8、如果缺少了某个物品，请联系作者增加一下。  
* 9、此逻辑未经过严谨测试，使用此脚本时请勿在包裹中保留太多银子，避免造成损失。   
