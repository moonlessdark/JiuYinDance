...
from DeskFunc.TaskBussinese.findMoXiTreasureHuntingLineLevel3 import MoXiMapLine
from DeskFunc.TaskBussinese.findMoXiTreasureHuntingLine import MoXiMapLine as MoXiMapLine2
...
class QuadrantChart(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('漠西风涛-挖宝(等级三)指引')
...
class QuadrantChart2(QtWidgets.QWidget):

    def __init__(self):
        super().__init__()

        self.func_mo_xi = MoXiMapLine2()  # 把业务模块引入进来
        ...
        self.setWindowTitle('漠西风涛-挖宝(等级二)指引')
